...
- **Sessão 59 (28/06/2026) — Início da migração planilha → Postgres (unificação c/ Dashboard):**
  ...
  - **Progresso prod:** Betano completa. Próximo na ordem da planilha: Pinnacle (ativas+arquivadas), Superbet, Betnacional + ~28 casas totalmente inativas. Bet365 ATIVAS (gleice/marlon/Talia) ainda pendentes (era recente). Base do operador: CSV separado, depois.
